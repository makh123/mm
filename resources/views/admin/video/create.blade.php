...
@section('content')
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-heading">
            <h2 class="panel-title">مدیریت ویدیوها</h2>
            ...
            <form class="form-horizontal" action="{{route('news.store')}}" method="post" id="contact"  enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <input type="text" class="form-control" name="title" id="title" placeholder="عنوان پست را وارد کنید." value="{{old('name')}}" maxlength="100">
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <textarea rows="2" maxlength="200" class="form-control" name="description" id="description" placeholder="توضیحات مختصر" maxlength="200">{{old('body')}}</textarea>
