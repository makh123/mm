...
<head>
    ...
    <!-- favicon
		============================================ -->
    <link rel="shortcut icon" type="image/x-icon" href="/panel/img/favicon.ico">
    <!-- Google Fonts
		============================================ -->
    ...
    <!-- owl.carousel CSS
		============================================ -->
    <link rel="stylesheet" href="/panel/css/owl.carousel.css">
    <link rel="stylesheet" href="/panel/css/owl.theme.css">
    <link rel="stylesheet" href="/panel/css/owl.transitions.css">
    <!-- meanmenu CSS
		============================================ -->
    <link rel="stylesheet" href="/panel/css/meanmenu/meanmenu.min.css">
    <!-- animate CSS
		============================================ -->
    <link rel="stylesheet" href="/panel/css/animate.css">
    <!-- normalize CSS
		============================================ -->
    <link rel="stylesheet" href="/panel/css/normalize.css">
    <!-- mCustomScrollbar CSS
		============================================ -->
    <link rel="stylesheet" href="/panel/css/scrollbar/jquery.mCustomScrollbar.min.css">
    <!-- jvectormap CSS
		============================================ -->
    <link rel="stylesheet" href="/panel/css/jvectormap/jquery-jvectormap-2.0.3.css">
    <!-- notika icon CSS
		============================================ -->
    <link rel="stylesheet" href="/panel/css/notika-custom-icon.css">
    <!-- wave CSS
		============================================ -->
    <link rel="stylesheet" href="/panel/css/wave/waves.min.css">
    <!-- main CSS
		============================================ -->
    ...
    <!-- responsive CSS
		============================================ -->
    <link rel="stylesheet" href="/panel/css/responsive.css">
    <!-- modernizr JS
		============================================ -->
    <script src="/panel/js/vendor/modernizr-2.8.3.min.js"></script>
</head>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="logo-area">
                    <a href="#"><img src="/panel/img/logo/logo.png" alt="" /></a>
                </div>
            </div>
                            ...
                            <div role="menu" class="dropdown-menu message-dd animated zoomIn">
                                ...
                                <div class="hd-message-info">
                                    <a href="#">
                                        <div class="hd-message-sn">
                                            <div class="hd-message-img">
                                                <img src="/panel/img/post/1.jpg" alt="" />
                                            </div>
                                            <div class="hd-mg-ctn">
                                                <h3>David Belle</h3>
                                    ...
                                    <a href="#">
                                        <div class="hd-message-sn">
                                            <div class="hd-message-img">
                                                <img src="/panel/img/post/4.jpg" alt="" />
                                            </div>
                                            <div class="hd-mg-ctn">
                                    ...
                                    <a href="#">
                                        <div class="hd-message-sn">
                                            <div class="hd-message-img">
                                                <img src="/panel/img/post/2.jpg" alt="" />
                                            </div>
                                            <div class="hd-mg-ctn">
                                                <h3>Glenn Jecobs</h3>
                                                <p>Cum sociis natoque penatibus et magnis dis parturient montes</p>
                        ...
                        <ul class="mobile-menu-nav">
                            <li><a data-toggle="collapse" data-target="#Charts" href="#">Home</a>
                                <ul class="collapse dropdown-header-top">
                                    <li><a href="/front/dashboard.blade.php">Dashboard One</a></li>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                    <li class="active"><a data-toggle="tab" href="#Home"><i class="notika-icon notika-house"></i> صفحه اصلی</a>
                    </li>
                    <li><a data-toggle="tab" href="#mailbox"><i class="notika-icon notika-mail"></i> ایمیل</a>
                    </li>
                    <li><a data-toggle="tab" href="#Interface"><i class="notika-icon notika-edit"></i> Interface</a>
                    </li>
                    <li><a data-toggle="tab" href="#Charts"><i class="notika-icon notika-bar-chart"></i> نمودار و چارت</a>
                    </li>
                    <li><a data-toggle="tab" href="#Tables"><i class="notika-icon notika-windows"></i> Tables</a>
                    </li>
                    <li><a data-toggle="tab" href="#Forms"><i class="notika-icon notika-form"></i> فرم ها</a>
                    </li>

                    </li>
                    <li><a data-toggle="tab" href="#Page"><i class="notika-icon notika-support"></i> حساب کاربری</a>
                    </li>
                </ul>
                <div class="tab-content custom-menu-content">
                    ...
                    <div id="Appviews" class="tab-pane notika-tab-menu-bg animated flipInX">
                        <ul class="notika-main-menu-dropdown">
                            ...
                            <li><a href="tabs.html">تب</a>
                            </li>
                            <li><a href="accordion.html">کشویی</a>
                            </li>
                            <li><a href="dialog.html">نمایش پیغام</a>
                            </li>
                    ...
                    <div id="Page" class="tab-pane notika-tab-menu-bg animated flipInX">
                        <ul class="notika-main-menu-dropdown">
                            <li><a href="contact.html">صفحه خالی تماس با ما</a>
                            </li>

                            <li><a href="typography.html">صفحه خالی</a>
                            </li>

                            <li><a href="/dashboard/login">ورود</a>
                            </li>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <div class="realtime-wrap notika-shadow mg-t-30">
                    ...
                    <div class="realtime-country-ctn realtime-ltd-mg">
                        ...
                        <div class="realtime-ctn-bw">
                            <div class="realtime-ctn-st">
                                <span><img src="/panel/img/country/1.png" alt="" /></span> <span>United States</span>
                            </div>
                    ...
                    <div class="realtime-country-ctn">
                        ...
                        <div class="realtime-ctn-bw">
                            <div class="realtime-ctn-st">
                                <span><img src="/panel/img/country/2.png" alt="" /></span> <span>Australia</span>
                            </div>
                            <div class="realtime-bw">
                                <span>Firefox</span>
                            </div>
                    ...
                    <div class="realtime-country-ctn">
                        ...
                        <div class="realtime-ctn-bw">
                            <div class="realtime-ctn-st">
                                <span><img src="/panel/img/country/3.png" alt="" /></span> <span>Brazil</span>
                            </div>
                            <div class="realtime-bw">
                                <span>Firefox</span>
                            </div>
                                ...
                                <ul class="conversation-list">
                                    <li class="clearfix">
                                        <div class="chat-avatar">
                                            <img src="/panel/img/post/1.jpg" alt="male">
                                            <i>10:00</i>
                                        </div>
                                    ...
                                    <li class="clearfix odd">
                                        <div class="chat-avatar">
                                            <img src="/panel/img/post/2.jpg" alt="Female">
                                            <i>10:01</i>
                                        </div>
                                        <div class="conversation-text">
                                    ...
                                    <li class="clearfix odd">
                                        <div class="chat-avatar">
                                            <img src="/panel/img/post/2.jpg" alt="male">
                                            <i>10:02</i>
                                        </div>
                                        <div class="conversation-text">
                                            <div class="ctext-wrap chat-widgets-cn">
...
<!-- jquery
    ============================================ -->
<script src="/panel/js/vendor/jquery-1.12.4.min.js"></script>
<!-- bootstrap JS
    ============================================ -->
<script src="/panel/js/bootstrap.min.js"></script>
<!-- wow JS
    ============================================ -->
<script src="/panel/js/wow.min.js"></script>
<!-- price-slider JS
    ============================================ -->
<script src="/panel/js/jquery-price-slider.js"></script>
<!-- owl.carousel JS
    ============================================ -->
<script src="/panel/js/owl.carousel.min.js"></script>
<!-- scrollUp JS
    ============================================ -->
<script src="/panel/js/jquery.scrollUp.min.js"></script>
<!-- meanmenu JS
    ============================================ -->
<script src="/panel/js/meanmenu/jquery.meanmenu.js"></script>
<!-- counterup JS
    ============================================ -->
<script src="/panel/js/counterup/jquery.counterup.min.js"></script>
<script src="/panel/js/counterup/waypoints.min.js"></script>
<script src="/panel/js/counterup/counterup-active.js"></script>
<!-- mCustomScrollbar JS
    ============================================ -->
<script src="/panel/js/scrollbar/jquery.mCustomScrollbar.concat.min.js"></script>
<!-- jvectormap JS
    ============================================ -->
<script src="/panel/js/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
<script src="/panel/js/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<script src="/panel/js/jvectormap/jvectormap-active.js"></script>
<!-- sparkline JS
    ============================================ -->
<script src="/panel/js/sparkline/jquery.sparkline.min.js"></script>
<script src="/panel/js/sparkline/sparkline-active.js"></script>
<!-- sparkline JS
    ============================================ -->
<script src="/panel/js/flot/jquery.flot.js"></script>
<script src="/panel/js/flot/jquery.flot.resize.js"></script>
<script src="/panel/js/flot/curvedLines.js"></script>
<script src="/panel/js/flot/flot-active.js"></script>
<!-- knob JS
    ============================================ -->
<script src="/panel/js/knob/jquery.knob.js"></script>
<script src="/panel/js/knob/jquery.appear.js"></script>
<script src="/panel/js/knob/knob-active.js"></script>
<!--  wave JS
    ============================================ -->
<script src="/panel/js/wave/waves.min.js"></script>
<script src="/panel/js/wave/wave-active.js"></script>
<!--  todo JS
    ============================================ -->
<script src="/panel/js/todo/jquery.todo.js"></script>
<!-- plugins JS
    ============================================ -->
<script src="/panel/js/plugins.js"></script>
<!--  Chat JS
    ============================================ -->
<script src="/panel/js/chat/moment.min.js"></script>
<script src="/panel/js/chat/jquery.chat.js"></script>
<!-- main JS
    ============================================ -->
<script src="/panel/js/main.js"></script>
<!-- tawk chat JS
    ============================================ -->
<script src="/panel/js/tawk-chat.js"></script>
</body>
