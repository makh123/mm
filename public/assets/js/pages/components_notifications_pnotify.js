...
$(function() {
    ...
    $('#pnotify-desktop-default').on('click', function () {
        ...
        (new PNotify({
            ...
            desktop: {
                desktop: true,
                addclass: 'bg-green',
                icon: 'assets/gallery/pnotify/default.png'
            }
        })
    ...
    $('#pnotify-desktop-danger').on('click', function () {
        ...
        (new PNotify({
            ...
            desktop: {
                desktop: true,
                icon: 'assets/gallery/pnotify/danger.png'
            }
        })
        ).get().click(function(e) {
            if ($('.ui-pnotify-closer, .ui-pnotify-sticker, .ui-pnotify-closer *, .ui-pnotify-sticker *').is(e.target)) return;
    ...
    $('#pnotify-desktop-success').on('click', function () {
        ...
        (new PNotify({
            ...
            desktop: {
                desktop: true,
                icon: 'assets/gallery/pnotify/success.png'
            }
        })
        ).get().click(function(e) {
            if ($('.ui-pnotify-closer, .ui-pnotify-sticker, .ui-pnotify-closer *, .ui-pnotify-sticker *').is(e.target)) return;
    ...
    $('#pnotify-desktop-warning').on('click', function () {
        ...
        (new PNotify({
            ...
            desktop: {
                desktop: true,
                icon: 'assets/gallery/pnotify/warning.png'
            }
        })
        ).get().click(function(e) {
            if ($('.ui-pnotify-closer, .ui-pnotify-sticker, .ui-pnotify-closer *, .ui-pnotify-sticker *').is(e.target)) return;
    ...
    $('#pnotify-desktop-info').on('click', function () {
        ...
        (new PNotify({
            ...
            desktop: {
                desktop: true,
                icon: 'assets/gallery/pnotify/info.png'
            }
        })
        ).get().click(function(e) {
            if ($('.ui-pnotify-closer, .ui-pnotify-sticker, .ui-pnotify-closer *, .ui-pnotify-sticker *').is(e.target)) return;
